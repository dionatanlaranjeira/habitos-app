...
mixin _$Person {
 ...
 String? get name; String? get email; String? get birthday; String? get phone; String? get avatarImage;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,email,birthday,phone,avatarImage);

@override
String toString() {
  return 'Person(name: $name, email: $email, birthday: $birthday, phone: $phone, avatarImage: $avatarImage)';
}
...
@useResult
$Res call({
 String? name, String? email, String? birthday, String? phone, String? avatarImage
});
...
/// Create a copy of Person
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = freezed,Object? email = freezed,Object? birthday = freezed,Object? phone = freezed,Object? avatarImage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? name,  String? email,  String? birthday,  String? phone,  String? avatarImage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Person() when $default != null:
return $default(_that.name,_that.email,_that.birthday,_that.phone,_that.avatarImage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? name,  String? email,  String? birthday,  String? phone,  String? avatarImage)  $default,) {final _that = this;
switch (_that) {
case _Person():
return $default(_that.name,_that.email,_that.birthday,_that.phone,_that.avatarImage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? name,  String? email,  String? birthday,  String? phone,  String? avatarImage)?  $default,) {final _that = this;
switch (_that) {
case _Person() when $default != null:
return $default(_that.name,_that.email,_that.birthday,_that.phone,_that.avatarImage);case _:
  return null;
...
class _Person implements Person {
   _Person({this.name, this.email, required this.birthday, required this.phone, this.avatarImage});
...
/// Create a copy of Person
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = freezed,Object? email = freezed,Object? birthday = freezed,Object? phone = freezed,Object? avatarImage = freezed,}) {
